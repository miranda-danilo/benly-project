...
const modules = [
    {
        id: 'WRITING',
        title: 'Writing Practices with AI',
    ...
    {
        id: 'LISTENING',
        title: 'Listening Practices with Stories',
    ...
    {
        id: 'READING',
        title: 'Reading Practices with AI',
    ...
    {
        id: 'SPEAKING',
        title: 'Speaking Practices with AI',
...
export function setupAdminPanelLogic(panelElement, adminRole) {
    ...
    function renderMobileMenu() {
        ...
        [
            ...
            { id: 'skills', label: 'Skill Practice', section: skillsSection },
    ...
    function renderMenu() {
        ...
        liSkills.innerHTML = `<a href="#" class="modulo-link-admin" id="admin-skills-link">SKILL PRACTICE</a>`;
